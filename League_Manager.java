...
public class final
{
	...
	{
     int [][] leaderBoard = new leaderBoard[5][13];
	 ArrayList<String> teams= new ArrayList<String>;
	 teams.add(new ArrayList<ArrayList<String>>);
	 teams.add(0).add("ggg");
	 teams.add(0).add("ggf");
	 teams.add(0).add("ggfdg");
	 teams.add(0).add("ggdg");
	 teams.add(0).add("ag");


	 //String b [][] = new String[leaderBoard[0])][leaderBoard.length+1];
	 String b [][] = new String[5][14];
	 ...
	 for(int i=0; i<leaderBoard.length; i++) 
	 {
			int [] row = leaderBoard[i];
			b[i] = new String[row.length+1];
